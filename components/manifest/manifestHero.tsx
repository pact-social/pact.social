    ...
    <>
      <div 
        ...
        style={{
          ...
          backgroundImage: `linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.2) 50%),url("${manifest?.picture ? `http://localhost:9011/ipfs/${manifest?.picture}` : "https://images.unsplash.com/photo-1573481078804-70c9d3406cff?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2333&q=80"}")`,
